        ...
        return (
         ...
         transition-shadow duration-300 p-2 md:p-4 relative  "
          >
            ...
            <h3 className="text-gray-500 font-bold">{product.brand ?product.brand:product.category}</h3>
            ...
            <p className="mt-2 text-red-500">{product.stock<10 ? "few stock left" : ""} </p>
          </div>
          </Link>
        );
      }) }
